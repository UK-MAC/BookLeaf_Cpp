...
main(int argc, char const *argv[])
{
    ...
    ConstView<int, VarDim, NCORN> elnd(
            (int *) pre_dump[1].data, pre_dump[1].size / NCORN);
    ...
    hydro::kernel::scatterAcceleration(zerocut, elsort, elnd, eldensity, cnwt,
            cnmass, cnfx, cnfy, ndarea, ndmass, ndudot, ndvdot, nel, nnd);
